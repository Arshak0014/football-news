<div style="padding: 20px">
    ...
    <form method="post">
        ...
        <label for="">Write Country Name *</label><br>
        <input class="create_page_inputs" placeholder="Write Country Name" type="text" name="country_name" value="<?= isset($_POST['country_name']) ? $_POST['country_name'] : null  ?>"/><br>
