    ...
    <section id="navArea">
        <nav class="navbar navbar-inverse" role="navigation">
            <div style="background: #ff7512;" class="navbar-header">
                <button style="background: #ff7512;border: white;" type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            </div>
                    ...
                    <li class="dropdown <?= \application\components\Router::getSegment('2') == \application\models\Sport::getSports()[0]['slug'] ? 'active' : null ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach (\application\models\Country::getCountries() as $country) : ?>
                                <li>
                                    <a href="/category/football/<?= $country['slug'] ?>"><?= $country['country_name'] ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
